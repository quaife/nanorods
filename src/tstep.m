...
%     if o.use_precond
% 
%       Xn = gmres(@(X) o.timeMatVec(X,geomTmp,walls,true,1:2),rhs,[],o.gmres_tol,...
%           4*Np,@o.preconditionerBD,[]);
%     else
      Xn = gmres(@(X) o.timeMatVec(X,geomTmp,walls,true,1:length(S)),rhs,[],o.gmres_tol,...
          4*Np);
    %end 
