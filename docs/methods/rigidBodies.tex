...
space-time interference volume.~\todo[inline]{Is this right?}.  However,
by limiting ourselves to two-dimensions, we are able to perform
simulations of denser suspensions with high-order accuracy.


\paragraph{Related work}

Particle suspensions in a viscous fluid is a well studied discipline.
The texts~\cite{Pozrikidis1992, Guazzelli2011} provide an excellent
overview of the theoretical formulation and applications of
microhydrodynamics, while ~cite{Karrila1991} places the theory in the
context of linear operators and provides some details on the numerical
methods needed. This paper draws largely on work done for 2D vesicle
suspensions~\cite{Quaife2014, Quaife2015, Quaife2015a, Rahimian2010,
Lu2017}. In particular we adopt the completed double layer potential
formulation~\cite{Power1987, Power1993, Karrila1989} that leads to a
well conditioned linear system. The resulting equations can be
discretized using the Galkerkin based boundary element
method~\cite{Mammoli1999, Mammoli2002, Mammoli2006} however we will the
spectrally accurate collocation Nystr\"{o}m method.  The kernels arising
...
solve the resistance problem in Stokes flow~\cite{Klinteberg2016}.An
...
methods~\cite{Klinteberg2014} work well for dilute suspensions, but can
