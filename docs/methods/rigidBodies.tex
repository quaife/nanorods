...
\caption{\label{fig:geomSchematic}Sketch of a possible domain $\Omega$.
  ...
  of inner solid walls.  Use $\dd_k$ for middle of inner solid walls.}
\end{figure}
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
for $\xx \in \gamma_k$, $k=1,\ldots,N$.  For our complete system, the
...
vector with size $\binom{N}{2}$ which is the total number of possible
