...
(Section~\ref{sec:pressure_stres}).
...
\end{align}
The rigid walls are identically discretized at $N_2$ points and
...
are now able to discretize the layer potentials.
\todo[inline]{Bryan left off here}

and interactions between nearly touching
