...
\begin{equation}
  ...
  \uu = \uu_b, &\hspace{20pt} \xx \in \Gamma, \gap 
    &&\mbox{wall velocity,} \\
...
domain, the boundary condition $\uu_b$ must satisfy the standard
flux-free condition, and in the case that the fluid domain is unbounded,
the wall velocity equation is replaced with a background flow
\begin{align*}
