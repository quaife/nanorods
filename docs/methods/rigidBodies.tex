...
satisfy~\eqref{eqn:BIEformulation2}.  Next, collision detection is
...
To compute the pressure and stress, odd-even integration with singularity subtraction is used~\cite{Quaife2014}.
