...
Miranda~\cite{pow-mir1987} to relate the strength of the Stokeslets and
...
size, and using lubrication theory is \todo[inline]{Maybe too hard for
dense suspensions with all possible case that can happen?}
...
\todo[inline]{New paper of Dhairya's to be added} have also been used to
