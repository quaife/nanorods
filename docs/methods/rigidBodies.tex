...
We compare our new time stepping method  We use the new time stepping
...
it is clear that additional algorithms or parameters need to be
adjusted.  Moreover, a more reliable algorithm for choosing an optimal
