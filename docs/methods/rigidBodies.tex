...
Particular challenges with the BIE formulation, especially for dense
suspensions, are large numbers of required GMRES iterations, expensive
matrix-vector multiplication, and weakly-singular and nearly-singular
