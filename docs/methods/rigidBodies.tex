...
qua-bir2014} \todo[inline]{need references from Barnett, Wu,
Veerapaneni, and regularization group (Beale, Cortez, Merced person?},
...
methods that control stiffness~\cite{qua-bir2014} \todo[inline]{other
papers here}, and use adaptive time step sizes~\cite{Kropinski1999,
qua-bir2016} \todo[inline]{other papers including Dhairya's recent
...
translational and angular velocities satisfy~\eqref{eqn:BIEformualtion}.
...
and torques are included in equation~\eqref{eqn:BIEformualtion5}.  To
