...
explicitly.  For example, the governing equation for the rigid
bodies~\eqref{eqn:BIEformulation2} are discretized as
\begin{align*}
  \uu_j^\tau + \omega_j(\xx - \cc_j^\gamma) = -\frac{1}{2}\eeta
\end{align*}
