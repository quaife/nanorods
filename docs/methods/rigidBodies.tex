...
\todo[inline]{Bryan leaves off here}
...
STIV, we include plots of pathlines that cross whenever the collision
...
one another.  Therefore, as the bodies approach, the pathlines behave
