...
\todo[inline]{Need a paragraph discussing results in
...
h$.  For $\delta \geq 2h$, reversibility is broken because the contact
force shifts the particles onto contact-free streamlines. When we
reverse the direction of the flow the particles traverse these
contact-free streamlines. 
