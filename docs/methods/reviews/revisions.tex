...
\begin{itemize}
  \item There are several differences regarding the paper by Malholtra
    ...
    they use a repulsion force rather than the STIV to maintain a
    contact-free suspension.  There method results in stiffness when the
  ...
  \item As this is our first paper for this project, we have focused on
    ...
    STIV contact, preconditioner, fast summation, etc.), to the best of
