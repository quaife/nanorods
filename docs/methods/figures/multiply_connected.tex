...
\begin{tikzpicture}
	...
	\draw[fill=white] (0,2) circle [x radius=0.5, y radius=1, rotate around={-45:(0,0)}];
	\draw[fill=white] (2,0) circle [x radius=0.5, y radius=1, rotate around={60:(0,0)}];
	\draw[fill=white] (-2,-1) circle [x radius=1, y radius=1];
	 \fill(0,2)circle(0.05);
	 \draw(0,2.2) node {$\mathbf{c}_1$};
	\fill(2,0)circle(0.05);
	 \draw(2,-0.2) node {$\mathbf{c}_2$};
	 \fill(-2,-1)circle(0.05);
	 \draw(-2,-0.8) node {$\mathbf{c}_3$};
	 \draw(0,1) node {$\Gamma_1$};
	 \draw(2,1) node {$\Gamma_2$};
	 \draw(-1,-2) node {$\Gamma_3$};
