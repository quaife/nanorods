...
\begin{tikzpicture}
	...
	\fill(2,0)circle(0.05);
	 ...
	 \draw(-2,-1.3) node {$\mathbf{c}^\Gamma_1$};
	 ...
	 \draw(0,2)--(0.8,2);
	  ...
	  \draw(2,0)--(0.8,0.8);
	 \draw(2,0)--(3,0);
	  \draw(2.2,0.2) node {$\theta_2$};
	  \draw[->](-7,0)--(-7.5,0);
	   \draw[->](-2,0)--(-2,-0.5);
	    \draw(-7.6,0.2) node {$\mathbf{n}$};
	      \draw(-2,-0.62) node {$\mathbf{n}$};
%	\draw[->](-0.63,1.23)--(-0.45,1.5);
	\draw[->](-0.63,1.23)--(-0.3528,1.6458);
        \draw(-0.32,1.75) node {$\mathbf{n}$};
	          \draw(5,0) node {\large$\Omega$};
%	  \draw[->](2.68,-0.62)--(2.4,-0.4);
	  \draw[->](2.68,-0.64)--(2.4460,-0.1980);
	  \draw(2.5,-0.1) node {$\mathbf{n}$};
